  		...
  		<div class="container-fluid">
  			...
  			switch(@$_GET['mod']) {
			      ...
			      <div class="blog-header">
			        <h1 class="blog-title" style="text-align: center;"><b>Latihan CRUD Sederhana</b></h1>
			      </div>
<br>
<br>
<br>
			      <p><a href='?mod=add'><button type='button' class='btn btn-primary'><span class='glyphicon glyphicon-plus-sign'></span>Tambah Data</button></a></p>
			    ...
			    break;
	   			...
	   			case 'add': ?>
					...
					<h2 style="text-align: center;"><b>Tambah User</b></h2>
					
					  <div class="form-group">
					    <label class="col-sm-1 control-label">Nama</label>
					    <div class="col-sm-4">
					      
					<input type="text" name='nama' class="form-control" placeholder="Ketikan nama disini">
					</div>
					  </div>
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-1 col-sm-4">
					      <button type='submit' name='submit' class='btn btn-primary' onClick="return confirm('Yakin ingin Tambah Data?')">Tambah Data</button>
					    </div>
					  </div>
					</form>
				<?php
				...
				case 'edit':
				    ...
				    <h2 style="text-align: center;"><b>Edit User</b></h2>
					  ...
					  <div class="form-group">
					    <div class="col-sm-offset-1 col-sm-4">
					      <button type='submit' name='submit' class='btn btn-primary' onClick="return confirm('Yakin ingin Edit Data?')">Save</button>
